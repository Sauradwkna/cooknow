...
<body>
    ...
    <div class="form-feedback-parent">
        <form action="send_feedback.php" method="post" class="form-feedback d-flex flex-column align-items-center">
            ...
            <input type="text" style=" width: 800px;" id="name" name="name" required>
            <p class="text-black m-0" style=" width: 800px;" ;>Email</p>
            <input type="email" style=" width: 800px;" id="email" name="email" required>
            ...
            <input type="text" style=" width: 800px; height :80px" id="message" name="message" rows="5" required>
            <br>
            <div class="fs-h4 btn btn-hvrss rounded-5 border border-3 px-4" type="submit">Kirim Feedback</div>
            <style>
                .btn-hvrss {
